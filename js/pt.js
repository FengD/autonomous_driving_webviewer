...
Potree.updateVisibility = function(pointclouds, camera, renderer){
	...
	//console.log("Points:",numVisiblePoints);
...
Potree.Viewer = class PotreeViewer extends THREE.EventDispatcher{
	...
	fitToScreen (factor = 1, animationDuration = 0) {
		...
		//this.controls.stop();
		//let view = this.scene.view;
		this.scene.view.yawDelta = 0;
		this.scene.view.pitchDelta = 0;
		this.scene.view.radiusDelta = 0;
		//this.scene.view.panDelta.set(0, 0);
	};
...
// http://epsg.io/
proj4.defs('WGS 84 (long/lat)', '+proj=longlat +datum=WGS84 +no_defs');
...
Potree.MapView = class {
	constructor (viewer) {
		...
		this.mapProjectionName = 'EPSG:4326';
